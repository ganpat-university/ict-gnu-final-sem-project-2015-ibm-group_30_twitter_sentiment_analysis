...
p_hist = hist(table_final$Positive, xlab = "Positive tweets", col=rainbow(10), main = 'Histogram of Positive tweets') #Positive
n_hist = hist(table_final$Negative, xlab = "Neg ative tweets", col=rainbow(10), main = 'Histogram of Negative tweets') #Negative
